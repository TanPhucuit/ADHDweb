...
import { Pill, Plus, Trash2, RefreshCw, RotateCcw, Clock, CheckCircle, AlertCircle, X } from "lucide-react"
...
const emptyForm = { medicationName: "", dosage: "1 viên", time: "08:00", notes: "" }
      ...
      <main className="container mx-auto px-4 py-6 space-y-5 max-w-2xl">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">Thiết lập lịch uống thuốc hàng ngày cho con</p>
          </div>
        </div>
          ...
          <>
            ...
            {fetching && medications.length === 0 ? (
              ...
              <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-10 text-center">
                ...
                <p className="font-bold text-gray-700 text-lg">Chưa có thuốc nào</p>
                <p className="text-gray-400 text-sm mt-1">Nhấn "Thêm thuốc" để thiết lập lịch uống thuốc cho con</p>
              </div>
            ) : (
              <div className="space-y-3">
                {medications.map(med => {
                  ...
                  return (
                    <div key={med.id} className={`bg-white rounded-2xl shadow-sm border-2 p-4 flex items-center gap-4 transition-all ${isTaken ? "border-green-200 opacity-80" : "border-purple-100"}`}>
            ...
            {medications.length > 0 && (
              <div className="bg-amber-50 border border-amber-200 rounded-2xl p-4 text-sm text-amber-700">
                <p className="font-semibold mb-0.5">Đặt lại mỗi ngày</p>
                <p className="text-amber-600">Nhấn <b>"Đặt lại ngày mới"</b> vào đầu mỗi ngày để reset trạng thái uống thuốc. Con sẽ thấy tất cả thuốc ở trạng thái "Chưa uống" và tích sao khi uống.</p>
              </div>
            )}
          </>
        )}
